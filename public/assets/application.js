  ...
  $(function() {
    ...
    $('.event-qtip').each(function() {
      ...
      return $(this).popover({
        ...
        content: "<i> " + ($(this).attr('data-location')) + "</i>                                <br/><br/>                " + ($(this).attr('data-exp')) + "                <br/><br/>                " + ($(this).attr('data-count')) + "                <br/><br/>                " + ((_ref = $(this).attr('data-before')) != null ? _ref : $(this).attr('data-before') + {
          '<br/>': ''
        }) + "                " + ((_ref1 = $(this).attr('data-after')) != null ? _ref1 : $(this).attr('data-after') + {
          '<br/>': ''
        }),
        trigger: 'hover',
        container: 'body'
