...
(function() {
  ...
  $(function() {
    ...
    $('#state').on('click', '#state_button_enable', function() {
      return $("#state").load("/admin/experiments/" + $(this).attr("data-id") + "/enable");
    });
    $('#state').on('click', '#state_button_disable', function() {
      return $("#state").load("/admin/experiments/" + $(this).attr("data-id") + "/disable");
    });
  ...
  $(function() {
    ...
    $(".guarded_form :input").change(function() {
      ...
      return window.onbeforeunload = function() {
        return "Achtung: Die Änderungen wurden noch nicht gespeichert!";
      };
    });
    ...
    $('a.add-url-link').click(function() {
      return $('#url-tags').append('<span> ... <input id="mail_restrictions__prefix" name="mail_restrictions[][prefix]" type="text" value="" /> ... @ ' + '<input id="mail_restrictions__suffix" name="mail_restrictions[][suffix]" type="text" value="" /><br/></span>');
    });
    $('a.remove-url-link').click(function() {
      return $('#url-tags span:last-child').remove();
    });
...
(function() {
  ...
  $(function() {
    update_languages();
    return $('#user_lang1, #user_lang2').change(update_languages);
  });
...
(function() {
  $(function() {
    var build_select;
    build_select = function(id) {
      var a, right_select, right_string, rights;
      ...
      right_string = (function() {
        ...
        for (_i = 0, _len = rights.length; _i < _len; _i++) {
          a = rights[_i];
          _results.push('<option value="' + a[1] + '">' + a[0] + '</option>');
        }
        return _results;
      })();
      return right_select = '<select class="chzn-select" data-placeholder="' + $('#usertable').data('rights-label') + '" id="rights' + id + '" multiple="multiple" name="rights[' + id + '][]" style="width:600px">' + right_string.join('') + '</select>';
    };
    $('#add_user').chosen().change(function() {
      var hidden_field, row, selected_id, selected_text;
    ...
    return $("#usertable").on("click", ".removeline", function() {
...
(function() {
  $(function() {
    ...
    update_checkboxes = function() {
      ...
      return $('#all_noshow').attr('checked', $('.noshow_checkbox:not(:checked)').size() === 0);
    };
...
(function() {
  $('body').on('click', '.insert_text', function() {
    var element_id;
  ...
  $(function() {
    $('body').on('click', '.save_template', function() {
      ...
      if (name !== null && name.length > 0) {
        $.post("/admin/templates", {
          ...
          return $('.template-menu').replaceWith(data);
        });
      }
      return false;
    });
    $('body').on('click', '.load_template', function() {
      ...
      if (confirm("Soll die Vorlage geladen und der aktuelle Text ersetzt werden?")) {
        $.post("/admin/templates", {
          mode: 'load',
          templatename: $(this).attr('data-name')
        }, function(data) {
